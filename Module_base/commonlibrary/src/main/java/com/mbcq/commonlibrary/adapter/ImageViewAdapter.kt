...
class ImageViewAdapter (context: Context?):BaseRecyclerAdapter<ImageViewBean>(context){
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder= ItemViewHolder(inflater.inflate(R.layout.base_imageview, parent, false))
