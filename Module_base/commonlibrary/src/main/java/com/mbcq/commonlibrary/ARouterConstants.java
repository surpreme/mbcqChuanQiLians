...
public class ARouterConstants {
    ...
    public static final String HouseActivity="/account/HouseActivity";
    ...
    public static final String ReceiptInformationActivity ="/order/ReceiptInformationActivity";
    ...
    public static final String FixedTrunkDepartureHouseActivity="/vehicles/FixedTrunkDepartureHouseActivity";
    ...
    public static final String TerminalAgentActivity="/vehicles/TerminalAgentActivity";
