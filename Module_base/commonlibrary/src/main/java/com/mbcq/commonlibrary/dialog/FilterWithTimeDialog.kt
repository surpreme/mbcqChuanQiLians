...
class FilterWithTimeDialog : BaseDialogFragment {
    ...
    override fun initView(view: View, savedInstanceState: Bundle?) {
        ...
        sure_btn.setOnClickListener {
            ...
            mClickInterface.onResult(mSelect.toString(), "$mStartTime@$mEndTime")
            dismiss()
        }
        initClickTime()
        initCurrentTime(1, 0)
