...
public class CommonTipDialog extends Dialog {
    ...
    private TextView tv_confirm,tv_unagain_ask;
    ...
    public CommonTipDialog(Context context) {
        ...
        tv_unagain_ask = (TextView) findViewById(R.id.tv_unagain_ask);
    ...
    public void setOnDialogButtonsClickListener(final OnDialogButtonsClickListener onDialogButtonsClickListener) {
        tv_unagain_ask.setOnClickListener(v->{
            onDialogButtonsClickListener.onNoAgainAskClick(v);
