package com.mbcq.baselibrary.view.recyclermove;
...
public class ItemDragHelperCallback extends ItemTouchHelper.Callback {
    ...
    public ItemDragHelperCallback(ItemTouchAdapter itemTouchAdapter){
    ...
    public ItemDragHelperCallback setOnDragListener(OnDragListener onDragListener) {
