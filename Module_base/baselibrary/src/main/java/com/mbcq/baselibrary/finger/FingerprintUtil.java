package com.mbcq.baselibrary.finger;
...
import com.mbcq.baselibrary.finger.bean.FingerprintBean;
...
public class FingerprintUtil {
    ...
    public static boolean isLocalFingerprintInfoChange(Context context) {
        ...
        String localFingerprintInfoString = SPUtil.getInstance().getString(FingerConstant.SP_LOCAL_FINGERPRINT_INFO, "");
