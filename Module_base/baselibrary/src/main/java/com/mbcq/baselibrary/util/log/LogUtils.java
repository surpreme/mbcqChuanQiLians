package com.mbcq.baselibrary.util.log;
...
public final class LogUtils {
    ...
    private static String sGlobalTag = "Liziyang"; // log标签
    ...
    public static class Builder {
        public Builder() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && BaseApplication.getContext().getApplicationContext().getExternalCacheDir() != null)
                defaultDir = BaseApplication.getContext().getApplicationContext().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                defaultDir = BaseApplication.getContext().getApplicationContext().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
