...
class ReceiptTuberculosisSalesInfoPresenter : BasePresenterImpl<ReceiptTuberculosisSalesInfoContract.View>(), ReceiptTuberculosisSalesInfoContract.Presenter {
    /**
