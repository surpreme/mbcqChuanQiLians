...
public class SchedulePaymentsPendingBean implements Serializable {
     ...
     * shipper : 彭小林
     * shipperCid :
     * shipperAddr : 1111111111
     * consigneeMb : 18614079838
     * consigneeTel : 55
     * consignee : 李紫洋
     * consigneeAddr : 哈哈
     * product : 玻璃
    ...
    private int isTransferCount;
    private String preVehicleNo;
    private String valueAddedService;
    private int bilThState;
    private String bilThStateStr;
    private String fetchdate;
    private String reportStateStr;
    private String reportDate;
    private String reportMan;
    private String conRepStaStr;
    private String conRepDat;
    private String conRepMan;
    ...
    public double getAccfactin() {
        return accfactin;
    }

    public void setAccfactin(double accfactin) {
        this.accfactin = accfactin;
    }
    ...
    public int getIsTransferCount() {
        return isTransferCount;
    }

    public void setIsTransferCount(int isTransferCount) {
        this.isTransferCount = isTransferCount;
    }

    public String getPreVehicleNo() {
        return preVehicleNo;
    }

    public void setPreVehicleNo(String preVehicleNo) {
        this.preVehicleNo = preVehicleNo;
    }
    ...
    public int getBilThState() {
        return bilThState;
    }

    public void setBilThState(int bilThState) {
        this.bilThState = bilThState;
    }

    public String getBilThStateStr() {
        return bilThStateStr;
    }

    public void setBilThStateStr(String bilThStateStr) {
    ...
    public String getConRepStaStr() {
        return conRepStaStr;
    }

    public void setConRepStaStr(String conRepStaStr) {
        this.conRepStaStr = conRepStaStr;
    }

    public String getConRepDat() {
        return conRepDat;
    }

    public void setConRepDat(String conRepDat) {
        this.conRepDat = conRepDat;
    }

    public String getConRepMan() {
        return conRepMan;
    }

    public void setConRepMan(String conRepMan) {
        this.conRepMan = conRepMan;
    }
