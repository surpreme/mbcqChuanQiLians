...
class PaymentingWriteOffPayCardPresenter : BasePresenterImpl<PaymentingWriteOffPayCardContract.View>(), PaymentingWriteOffPayCardContract.Presenter {
    /**
     *
    ...
    override fun savePayCardInfo(jsonObj: JSONObject) {
        post<String>(ApiInterface.PAYMENTING_WRITE_OFF_SAVE_INFO_POST, getRequestBody(jsonObj), object : CallBacks {
            override fun onResult(result: String) {
