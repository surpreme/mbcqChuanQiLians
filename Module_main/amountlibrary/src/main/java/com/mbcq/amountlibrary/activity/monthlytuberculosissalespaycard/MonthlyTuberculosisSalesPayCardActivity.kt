...
import kotlinx.android.synthetic.main.activity_monthly_tuberculosis_sales_pay_card.*
...
@Route(path = ARouterConstants.MonthlyTuberculosisSalesPayCardActivity)
class MonthlyTuberculosisSalesPayCardActivity : BaseMVPActivity<MonthlyTuberculosisSalesPayCardContract.View, MonthlyTuberculosisSalesPayCardPresenter>(), MonthlyTuberculosisSalesPayCardContract.View {
    @Autowired(name = "xSelectData")
    @JvmField
    var xSelectData: String = ""
    var mTextViewAdapter: TextViewAdapter<BaseTextAdapterBean>? = null
    
    override fun getLayoutId(): Int = R.layout.activity_monthly_tuberculosis_sales_pay_card
    ...
    override fun onClick() {
        ...
        monthly_tuberculosis_sales_paycard_toolbar.setBackButtonOnClickListener(object : SingleClick() {
