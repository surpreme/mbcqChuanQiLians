...
import kotlinx.android.synthetic.main.activity_common_write_off_info.*
import org.json.JSONObject

/**
 * @author: lzy
 * @time: 2021-01-13 15:11:10 应收核销详情
 */

@Route(path = ARouterConstants.CommonWriteOffInfoActivity)
class CommonWriteOffInfoActivity : BaseMVPActivity<CommonWriteOffInfoContract.View, CommonWriteOffInfoPresenter>(), CommonWriteOffInfoContract.View {
    @Autowired(name = "WriteoffInfo")
    @JvmField
    var mLastData: String = ""

    override fun getLayoutId(): Int = R.layout.activity_common_write_off_info
    ...
    override fun initViews(savedInstanceState: Bundle?) {
        ...
        common_writeoff_info_toolbar.setCenterTitleText(mShowObj.optString("mCommonTitleStr") + "详情")
    ...
    override fun onClick() {
        ...
        common_writeoff_info_toolbar.setBackButtonOnClickListener(object : SingleClick() {
