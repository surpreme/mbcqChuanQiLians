...
import kotlinx.android.synthetic.main.activity_monthly_tuberculosis_sales_info.*
...
@Route(path = ARouterConstants.MonthlyTuberculosisSalesInfoActivity)
class MonthlyTuberculosisSalesInfoActivity : BaseMVPActivity<MonthlyTuberculosisSalesInfoContract.View, MonthlyTuberculosisSalesInfoPresenter>(), MonthlyTuberculosisSalesInfoContract.View {
    @Autowired(name = "WriteoffInfo")
    @JvmField
    var mLastData: String = ""

    override fun getLayoutId(): Int = R.layout.activity_monthly_tuberculosis_sales_info
    ...
    override fun onClick() {
        ...
        monthly_tuberculosis_sales_info_toolbar.setBackButtonOnClickListener(object : SingleClick() {
