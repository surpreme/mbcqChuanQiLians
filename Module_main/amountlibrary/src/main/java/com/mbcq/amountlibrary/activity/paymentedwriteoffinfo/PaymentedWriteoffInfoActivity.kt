...
import kotlinx.android.synthetic.main.activity_paymented_writeoff_info.*
...
@Route(path = ARouterConstants.PaymentedWriteoffInfoActivity)
class PaymentedWriteoffInfoActivity : BaseMVPActivity<PaymentedWriteoffInfoContract.View, PaymentedWriteoffInfoPresenter>(), PaymentedWriteoffInfoContract.View {
    @Autowired(name = "WriteoffInfo")
    @JvmField
    var mLastData: String = ""

    override fun getLayoutId(): Int = R.layout.activity_paymented_writeoff_info
    ...
    override fun onClick() {
        ...
        paymented_write_off_paycard_info_toolbar.setBackButtonOnClickListener(object : SingleClick() {
