...
class CommonReceiveWriteOffAdapter(context: Context) : BaseRecyclerAdapter<CommonReceiveWriteOffBean>(context) {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        (holder as ItemViewHolder).waybill_number_tv.text = if (mDatas[position].billno.isNullOrBlank()) mDatas[position].inoneVehicleFlag else mDatas[position].billno
