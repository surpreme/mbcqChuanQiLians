...
class MonthlyTuberculosisSalesInfoPresenter : BasePresenterImpl<MonthlyTuberculosisSalesInfoContract.View>(), MonthlyTuberculosisSalesInfoContract.Presenter {
    /**
