...
import kotlinx.android.synthetic.main.activity_paymenting_write_off_pay_card.*
...
@Route(path = ARouterConstants.PaymentingWriteOffPayCardActivity)
class PaymentingWriteOffPayCardActivity : BaseMVPActivity<PaymentingWriteOffPayCardContract.View, PaymentingWriteOffPayCardPresenter>(), PaymentingWriteOffPayCardContract.View {
    @Autowired(name = "xSelectData")
    @JvmField
    var xSelectData: String = ""

    override fun getLayoutId(): Int = R.layout.activity_paymenting_write_off_pay_card
    ...
    override fun onClick() {
        ...
        paymenting_write_off_paycard_toolbar.setBackButtonOnClickListener(object : SingleClick() {
