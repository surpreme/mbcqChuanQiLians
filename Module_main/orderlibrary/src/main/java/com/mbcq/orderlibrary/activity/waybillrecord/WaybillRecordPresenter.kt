...
class WaybillRecordPresenter : BasePresenterImpl<WaybillRecordContract.View>(), WaybillRecordContract.Presenter {
    /**
     * {
    "code": 0,
    "msg": "",
    ...
    override fun getPageData(page: Int, commonStr: String, startDate: String, endDate: String) {
    ...
    override fun deleteWayBill(billno: String, mIndex:Int) {
        val jsonObj = JsonObject()
        jsonObj.addProperty("id", billno)
        post<String>(ApiInterface.WAYBILL_RECORD_DELETE_INFO_POST, getRequestBody(jsonObj),  object : CallBacks {
            override fun onResult(result: String) {
                mView?.deleteWayBillS(mIndex)
            }
