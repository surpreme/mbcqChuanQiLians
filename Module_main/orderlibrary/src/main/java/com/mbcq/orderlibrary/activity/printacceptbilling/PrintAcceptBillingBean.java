...
public class PrintAcceptBillingBean {
    /**
     * id : 175
     * companyId : 2001
     * eCompanyId : 2001
    ...
    private String isTransferCount;
    ...
    public String getIsTransferCount() {
        return isTransferCount;
    }

    public void setIsTransferCount(String isTransferCount) {
    ...
    public String getBilThState() {
        return bilThState;
    }

    public void setBilThState(String bilThState) {
