...
class WaybillRecordAdapter(context: Context?) : BaseRecyclerAdapter<WaybillRecordBean>(context) {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        holder.record_checkbox_iv.setImageDrawable(context?.getDrawable(if (mDatas[position].checked) R.drawable.ic_checked_icon else R.drawable.ic_unchecked_icon))
        holder.record_checkbox_iv.setOnClickListener(object : SingleClick() {
            override fun onSingleClick(v: View?) {
                if (!mDatas[position].checked) {
                    mDatas[position].checked = true
                    holder.record_checkbox_iv.setImageDrawable(context?.getDrawable(R.drawable.ic_checked_icon))
                } else {
                    mDatas[position].checked = false
                    holder.record_checkbox_iv.setImageDrawable(context?.getDrawable(R.drawable.ic_unchecked_icon))
                }
