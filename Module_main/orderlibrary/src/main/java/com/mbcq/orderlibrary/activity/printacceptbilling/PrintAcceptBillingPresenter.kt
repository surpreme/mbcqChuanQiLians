...
class PrintAcceptBillingPresenter : BasePresenterImpl<PrintAcceptBillingContract.View>(), PrintAcceptBillingContract.Presenter {
    /**
        ...
        get<String>(ApiInterface.RECORD_SELECT_ORDER_INFO_GET, params, object : CallBacks {
            override fun onResult(result: String) {
                ...
                obj.optJSONArray("data")?.let {
                    if (!it.isNull(0)) {
                        mView?.getWayBillInfoS(it.getJSONObject(0), it.optString(0))
