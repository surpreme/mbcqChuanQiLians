...
class ReceiptGeneralLedgerAdapter(context: Context) : BaseRecyclerAdapter<ReceiptGeneralLedgerBean>(context) {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder = ItemViewHolder(inflater.inflate(R.layout.item_receipt_general_ledger, parent, false))
