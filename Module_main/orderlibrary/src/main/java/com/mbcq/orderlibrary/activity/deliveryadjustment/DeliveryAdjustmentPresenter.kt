...
class DeliveryAdjustmentPresenter : BasePresenterImpl<DeliveryAdjustmentContract.View>(), DeliveryAdjustmentContract.Presenter {
    /**
    ...
    override fun updateData(jsonObject: JSONObject) {
        post<String>(ApiInterface.DELIVERY_ADJUSTMENT_UPDATE_POST,getRequestBody(jsonObject),object:CallBacks{
            override fun onResult(result: String) {
                mView?.updateDataS()
            }
