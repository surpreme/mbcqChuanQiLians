...
import com.mbcq.orderlibrary.activity.choiceshipper.ChoiceShipperAdapter
...
class ChoiceReceiverAdapter(context: Context) : BaseRecyclerAdapter<ChoiceReceiverBean>(context) {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        (holder as ItemViewHolder).basic_info_tv.text = "${mDatas[position].contactMan} ${mDatas[position].contactMb} ${mDatas[position].cVipId}"
