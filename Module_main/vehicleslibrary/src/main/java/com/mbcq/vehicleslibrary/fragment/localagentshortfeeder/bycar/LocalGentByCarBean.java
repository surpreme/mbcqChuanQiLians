package com.mbcq.vehicleslibrary.fragment.localagentshortfeeder.bycar;
...
public class LocalGentByCarBean {
    ...
    public String getVehicleNoTmp() {
        return vehicleNoTmp;
    }

    public void setVehicleNoTmp(String vehicleNoTmp) {
        this.vehicleNoTmp = vehicleNoTmp;
    }
