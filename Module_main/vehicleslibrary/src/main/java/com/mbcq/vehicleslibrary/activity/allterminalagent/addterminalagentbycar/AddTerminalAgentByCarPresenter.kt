...
class AddTerminalAgentByCarPresenter : BasePresenterImpl<AddTerminalAgentByCarContract.View>(), AddTerminalAgentByCarContract.Presenter {
    /**
     *
    ...
    override fun getDepartureBatchNumber() {
        get<String>(ApiInterface.TERMINAL_AGENT_BATCH_NUMBER_GET + "?=", null, object : CallBacks {
