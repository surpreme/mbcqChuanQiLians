...
abstract class BaseFixedDepartureTrunkConfigurationActivity<V : BaseView, T : BasePresenterImpl<V>> : BaseMVPActivity<V, T>(), BaseView {
...
//            cash_freight_tv.text = ""
    ...
    override fun onClick() {
        super.onClick()
        fixed_trunk_departure_configuration_toolbar.setBackButtonOnClickListener(object : SingleClick() {
