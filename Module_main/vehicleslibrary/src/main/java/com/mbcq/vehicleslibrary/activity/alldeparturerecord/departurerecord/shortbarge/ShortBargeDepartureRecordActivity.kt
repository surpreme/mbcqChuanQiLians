package com.mbcq.vehicleslibrary.activity.alldeparturerecord.departurerecord.shortbarge
...
import kotlinx.android.synthetic.main.activity_short_barge_departure_record.*

@Route(path = ARouterConstants.ShortBargeDepartureRecordActivity)
class ShortBargeDepartureRecordActivity : BaseActivity() {
    override fun getLayoutId(): Int = R.layout.activity_short_barge_departure_record
        ...
        departure_billing_toolbar.setRightButtonOnClickListener {
            WebDbUtil.getDbWebId(application, object : WebsDbInterface {
                ...
                override fun isSuccess(list: MutableList<WebAreaDbInfo>) {
                    FilterWithTimeDialog(getScreenWidth(), Gson().toJson(list), "webid", "webidCode", true, "短驳发车记录筛选", true, mClickInterface = object : OnClickInterface.OnClickInterface {
                        /**
                         * s1 网点
                         * s2  start@end
                         */
                    ...
                    }).show(supportFragmentManager, "ShortBargeDepartureRecordFilterWithTimeDialog")
                }
