...
public class FixShortFeederHouseCarInfo {
     ...
     * companyId : 2001
     * ecompanyId : 2001
     * inoneVehicleFlag : DB1003-20200916-001
     * contractNo : DB1003-20200916-001
     * sendOpeMan : 汕头
     * arriOpeMan :
     * webidCode : 1003
     * webidCodeStr : 汕头
    ...
    private List<StockWaybillListBean> item;
    ...
    public List<StockWaybillListBean> getItem() {
        return item;
    }

    public void setItem(List<StockWaybillListBean> item) {
        this.item = item;
    }
