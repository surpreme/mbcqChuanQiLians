...
class FixedVehicleArchivesPresenter : BasePresenterImpl<FixedVehicleArchivesContract.View>(), FixedVehicleArchivesContract.Presenter {
    override fun saveInfo(jsonObject: JSONObject) {
        post<String>(ApiInterface.VEHICLE_ARCHIVES_CHANGE_POST,getRequestBody(jsonObject),object:CallBacks{
            override fun onResult(result: String) {
                mView?.saveInfoS("车辆档案新修改完成，点击返回查看详情！")
            }
