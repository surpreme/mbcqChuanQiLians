...
class ArrivalShortScanOperatingMoreInfoAdapter(context: Context) : BaseRecyclerAdapter<ArrivalShortScanOperatingMoreInfoBean>(context) {
...
//        holder.dismantle_info_tv.text = mDatas[position].mDismantleInfo
        ...
        holder.scan_info_father_cl.setBackgroundResource(if (mDatas[position].isScan) R.color.base_scan_background_green else R.drawable.hollow_out_gray)
