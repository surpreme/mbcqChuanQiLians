...
abstract class BaseFixedShortFeederConfigurationActivity<V : BaseView, T : BasePresenterImpl<V>> : BaseMVPActivity<V, T>(), BaseView {
    ...
    override fun onClick() {
        ...
        fixed_short_feeder_config_toolbar.setBackButtonOnClickListener(object : SingleClick() {
            override fun onSingleClick(v: View?) {
                onBackPressed()
            }
