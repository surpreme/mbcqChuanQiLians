...
class LocalGentByOrderPresenter : BasePresenterImpl<LocalGentByOrderContract.View>(), LocalGentByOrderContract.Presenter {
    /**
...
//        params.put("endDate", endDate)
        get<String>(ApiInterface.LOCAL_AGENT_RECORD_SELECT_INFO_GET, params, object : CallBacks {
            override fun onResult(result: String) {
                ...
                if (json is JSONArray) {
                    val list = Gson().fromJson<List<LocalGentByOrderBean>>(obj.optString("data"), object : TypeToken<List<LocalGentByOrderBean>>() {}.type)
                    list?.let {
                        mView?.getPageS(it)
                    }
                }
    ...
    override fun cancel(s: LocalGentByOrderBean, position: Int) {
