...
class FixedScanShortFeederConfigurationPresenter : BasePresenterImpl<FixedScanShortFeederConfigurationContract.View>(), FixedScanShortFeederConfigurationContract.Presenter {
    /**
