...
class DepartureTrunkDepartureUnPlanScanOperatingAdapter(context: Context) : BaseRecyclerAdapter<DepartureTrunkDepartureUnPlanScanOperatingBean>(context) {
    ...
    interface OnLookInformationInterface {
        fun lookInfo(v: View, position: Int, data: DepartureTrunkDepartureUnPlanScanOperatingBean)
        fun lookAllInfo(v: View, position: Int, data: DepartureTrunkDepartureUnPlanScanOperatingBean)
    }
