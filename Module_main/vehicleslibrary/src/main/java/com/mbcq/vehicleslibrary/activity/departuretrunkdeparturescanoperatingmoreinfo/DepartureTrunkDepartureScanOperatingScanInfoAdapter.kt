...
import com.mbcq.vehicleslibrary.activity.shorttrunkdeparturescanoperatingmoreinfo.ShortTrunkDepartureScanOperatingMoreInfoAdapter

class DepartureTrunkDepartureScanOperatingScanInfoAdapter(context: Context) : BaseRecyclerAdapter<DepartureTrunkDepartureScanOperatingScanInfoBean>(context) {
