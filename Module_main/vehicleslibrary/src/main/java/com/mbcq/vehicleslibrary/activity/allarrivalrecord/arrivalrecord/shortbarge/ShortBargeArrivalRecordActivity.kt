package com.mbcq.vehicleslibrary.activity.allarrivalrecord.arrivalrecord.shortbarge
...
@Route(path = ARouterConstants.ShortBargeArrivalRecordActivity)
class ShortBargeArrivalRecordActivity : BaseActivity() {
        ...
        arrival_record_toolbar.setRightButtonOnClickListener {
            WebDbUtil.getDbWebId(application, object : WebsDbInterface {
                ...
                override fun isSuccess(list: MutableList<WebAreaDbInfo>) {
                    FilterWithTimeDialog(getScreenWidth(), Gson().toJson(list), "webid", "webidCode", true, "短驳到车记录筛选", true, mClickInterface = object : OnClickInterface.OnClickInterface {
                        /**
                         * s1 网点
                         * s2  start@end
                         */
