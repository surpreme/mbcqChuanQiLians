...
class ShortTrunkDepartureUnPlanScanOperatingPresenter : BasePresenterImpl<ShortTrunkDepartureUnPlanScanOperatingContract.View>(), ShortTrunkDepartureUnPlanScanOperatingContract.Presenter {
     ...
     */
    override fun scanOrder(billno: String, lableNo: String, deviceNo: String, inOneVehicleFlag: String, soundStr: String, ewebidCode: String, ewebidCodeStr: String, scanPercentage: String, mMoreScanBillno: String, mScanType: Int) {
