            ...
            override fun onResult(result: String) {
                ...
                obj.optJSONArray("data")?.let {
                    if (!it.isNull(1)) {
                        ...
                        var mXid = -1
                        if (mShortTrunkDepartureUnPlanScanOperatingIdBean.data.isNotEmpty()) {
                            if (mShortTrunkDepartureUnPlanScanOperatingIdBean.data[0].data.isNotEmpty())
                                mXid = mShortTrunkDepartureUnPlanScanOperatingIdBean.data[0].data[0].id
                        ...
                        mView?.getCarInfoS(Gson().fromJson(dataObj.optString("data"), object : TypeToken<List<ShortTrunkDepartureUnPlanScanOperatingBean>>() {}.type), mXid)
                    }
                }
            }
