...
public class DepartureTrunkDepartureUnPlanScanOperatingBean {

    /**
     * sendOpeMan : lzy
     * arriOpeMan :
     * sendDate : 2020-11-18T14:23:53
     * arrivedDate : 1900-01-01T00:00:00
     * inoneVehicleFlag : GX1003-20201118-003
     * qtyGx : 1
     * unLoadQty : 1
     * loadQty : 0
     * webidCodeGx : 1003
    ...
    private int loadQty;
    private int webidCodeGx;
    private String webidCodeStrGx;
    private int ewebidCodeGx;
    private String ewebidCodeStrGx;
    private int state;
    ...
    public int getWebidCodeGx() {
        return webidCodeGx;
    }

    public void setWebidCodeGx(int webidCodeGx) {
        this.webidCodeGx = webidCodeGx;
    }

    public String getWebidCodeStrGx() {
        return webidCodeStrGx;
    }

    public void setWebidCodeStrGx(String webidCodeStrGx) {
        this.webidCodeStrGx = webidCodeStrGx;
    }

    public int getEwebidCodeGx() {
        return ewebidCodeGx;
    }

    public void setEwebidCodeGx(int ewebidCodeGx) {
        this.ewebidCodeGx = ewebidCodeGx;
    }

    public String getEwebidCodeStrGx() {
        return ewebidCodeStrGx;
    }

    public void setEwebidCodeStrGx(String ewebidCodeStrGx) {
        this.ewebidCodeStrGx = ewebidCodeStrGx;
    }
