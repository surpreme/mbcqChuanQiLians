...
class LocalGentShortFeederHouseInfoPresenter : BasePresenterImpl<LocalGentShortFeederHouseInfoContract.View>(), LocalGentShortFeederHouseInfoContract.Presenter {
    /**
