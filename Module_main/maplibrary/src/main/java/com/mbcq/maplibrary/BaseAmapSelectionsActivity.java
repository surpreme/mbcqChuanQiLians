...
import com.mbcq.maplibrary.view.SearchResultAdapter;
import com.mbcq.maplibrary.view.SegmentedGroup;
...
public class BaseAmapSelectionsActivity extends AppCompatActivity implements LocationSource,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.selection_map_fragment);

        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            StatusBarUtils.setColor(this, getColor(R.color.white));
        }

        mapView = (MapView) findViewById(R.id.base_gaode_mapview);
    ...
    private void initView() {
        ...
        searchResultAdapter = new SearchResultAdapter(BaseAmapSelectionsActivity.this);
        ...
        searchText.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (newText.length() > 0) {
                    ...
                    Inputtips inputTips = new Inputtips(BaseAmapSelectionsActivity.this, inputquery);
...
//        aMap.setMyLocationType(AMap.LOCATION_TYPE_LOCATE);
        ...
        aMap.animateCamera(CameraUpdateFactory.zoomTo(26));
...
//        Log.i("MY", "doSearchQuery");
        ...
        if (searchLatlonPoint != null) {
            ...
            poiSearch.setBound(new PoiSearch.SearchBound(searchLatlonPoint, 2600, true));//
    ...
    public void onRegeocodeSearched(RegeocodeResult result, int rCode) {
        ...
        if (rCode == AMapException.CODE_AMAP_SUCCESS) {
            ...
            Toast.makeText(BaseAmapSelectionsActivity.this, "error code is " + rCode, Toast.LENGTH_SHORT).show();
        }
    }
            ...
            if (poiResult != null && poiResult.getQuery() != null) {
                if (poiResult.getQuery().equals(query)) {
                    ...
                    if (poiItems != null && poiItems.size() > 0) {
                        ...
                        Toast.makeText(BaseAmapSelectionsActivity.this, "无搜索结果", Toast.LENGTH_SHORT).show();
                    }
                }
            } else {
                Toast.makeText(BaseAmapSelectionsActivity.this, "无搜索结果", Toast.LENGTH_SHORT).show();
    ...
    public String getmSelectAddress() {
    ...
    public void startJumpAnimation() {
        ...
        if (locationMarker != null) {
            ...
            point.y -= dip2px(BaseAmapSelectionsActivity.this, 125);
    ...
    Inputtips.InputtipsListener inputtipsListener = new Inputtips.InputtipsListener() {
        ...
        public void onGetInputtips(List<Tip> list, int rCode) {
            if (rCode == AMapException.CODE_AMAP_SUCCESS) {// 正确返回
                ...
                Toast.makeText(BaseAmapSelectionsActivity.this, "erroCode " + rCode, Toast.LENGTH_SHORT).show();
            }
        }
    };
    ...
    private void searchPoi(Tip result) {
        ...
        aMap.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(searchLatlonPoint.getLatitude(), searchLatlonPoint.getLongitude()), 26f));
